        ...
        <div class="col-md-6">
            <form action="the_categories" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="categoryImage" name="categoryImage" class="form-control-file" accept="image/png, image/jpeg" required>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-6">
            <form action="the_products" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="productImage" name="productImage" class="form-control-file" accept="image/png, image/jpeg" required>
                </div>
        ...
        <div class="col-md-6">
            <form action="post_blog" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="blogimg" name="blogimg" class="form-control-file" accept="image/png, image/jpeg" required>
                </div>
                <div class="form-group">
