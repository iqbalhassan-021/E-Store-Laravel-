        ...
        <div class="slide-container disp-flex-row">
            <div class="the-content disp-flex-col">
                <div class="slide-text">
                    <p class="title">
                        <strong>{{$slidercontent->slideproductName}}</strong>
                    </p>
                    <p class="tagline">{{$slidercontent->id}}</p>
                    <p class="desc">{{$slidercontent->slideproductDesc}}</p>
                    <a href="{{url('/product/'.$slidercontent->id)}}" class="no-decoration link">Learn more</a>
                </div> 
            </div>
