...
@include('components.header')
        ...
        <div class="body-cover ">
            ...
            <div class="details-tab">
                ...
                <p class="desc" >
                    ...
                    @if(empty($searchResults->first()->shippingfees))
                    2
                    @else
                    {{$searchResults->first()->shippingfees}}
                    @endif
                    </span>
    ...
    <div class="popup-content">
        ...
        @csrf
            ...
            <input type="text" id="productName" name="productName" value="{{$searchResults->first()->productName}}" readonly class="input-field">

            <!-- Product ID -->
            <label for="productId">Product ID:</label>
            <input type="text" id="productId" name="productId" value="{{$searchResults->first()->id}}" readonly class="input-field">

            <!-- Product Description -->
            <label for="productDescription">Product Description:</label>
            <textarea type="text" id="productDescription" name="productDescription" readonly class="desc" rows="10" style="width: 100%; padding: 10px;">{{$searchResults->first()->productDescription}}</textarea>

            <!-- Product Price -->
            <label for="productPrice">Product Price:</label>
            <input type="text" id="productPrice" name="productPrice" value="${{$searchResults->first()->productPrice}}" readonly class="input-field">

            <!-- Product Size -->
            <label for="productSize">Product Size:</label>
            <input type="text" id="productSize" name="productSize" value="{{$searchResults->first()->productsize}}" readonly class="input-field">
           ...
           {{ session()->get('message') }}
            ...
            <!-- Submit Button -->
            <button type="submit" class="button button-big desc" style="margin-top: 20px;">Confirm Order</button>
        </form>
    </div>
</div>
